...
logging.basicConfig(
    filename="log/vendor_summary.log",
    level=logging.DEBUG,
...
def create_vendor_summary(conn):
    '''this function will merge the different table to get overall vendor summary ab=nd adding new columns in the resultant data'''
...
if __name__ == '__main__':
    ...
    logging.info('Ingesting Vendor Summary Table into Database.... ')
    ingest_db(clean_df, 'vendor_sales_summary', conn)
    logging.info('Vendor Summary Ingestion Complete.')
